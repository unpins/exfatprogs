...
- **Multicall:** the six programs are folded into one ELF/Mach-O/APE via a source-level `main` → `<prog>_main` rename (`lib.cppRenameMulticall`), keeping a single copy of the shared `libexfat.a`.
